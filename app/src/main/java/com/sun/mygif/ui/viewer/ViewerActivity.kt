...
class ViewerActivity : BaseActivity(), View.OnClickListener {
    ...
    private val scaledWidth = (screenWidth * 0.9).toInt()
    private val scaledHeight = (screenHeight * 0.8).toInt()
    private val scaledRatio = scaledWidth / scaledHeight
